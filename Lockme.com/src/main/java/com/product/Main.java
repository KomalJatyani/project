         ...
         System.out.println("Enter Product Name:");
          ...
          System.out.println(e.getMessage());}
			...
			// TODO: handle exception
        	 ...
        	 break;
         case 2:System.out.println("Enter product id to get deatil:");
         try {
        	 int id = Integer.parseInt(scer.nextLine());
        	 Product product2 = productBo.getProductById(id);
        	 if (product2!=null)
        	 {
        		 System.out.println("deatail of "+ id +"product is  ---");
			...
			// TODO: handle exception
			System.out.println("Only enter integer form");
		}catch(BussinessException e)
         {
			System.out.println(e.getMessage());
         }
